    ...
    <ul class="navbar-nav ml-auto">
        ...
        <li class="nav-item dropdown no-arrow d-sm-none">
            ...
            <div class="dropdown-menu dropdown-menu-right p-3 shadow animated--grow-in"
                ...
                <form method="POST" accept="{{ route('applicant.search') }}" class="form-inline mr-auto w-100 navbar-search">
                    @csrf
                    <div class="input-group">
                        <input type="text" name="q" class="form-control bg-light border-0 small" placeholder="Search for applicant via number..." aria-label="Search"  aria-describedby="basic-addon2">
                        <div class="input-group-append">
                            <button class="btn btn-primary" type="submit">
                                <i class="fas fa-search fa-sm"></i>
                            </button>
